...
class Ui_recommend_up:
    def setupUi(self, recommend_up):  # noqa: PLR0915
        if not recommend_up.objectName():
            recommend_up.setObjectName("recommend_up")
        recommend_up.resize(800, 600)
        recommend_up.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QWidget(recommend_up)
        ...
        recommend_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(recommend_up)

        QMetaObject.connectSlotsByName(recommend_up)

    # setupUi

    def retranslateUi(self, recommend_up):
        recommend_up.setWindowTitle(QCoreApplication.translate("recommend_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("recommend_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate(
                "recommend_up",
                "<html><head/><body><p>\u63a8\u8350</p></body></html>",
                None,
            )
        )
        self.home_page.setText(QCoreApplication.translate("recommend_up", "\u9996\u9875", None))
