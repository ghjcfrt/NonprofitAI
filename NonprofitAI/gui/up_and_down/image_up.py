...
class Ui_image_up:
    def setupUi(self, image_up):  # noqa: PLR0915
        if not image_up.objectName():
            image_up.setObjectName("image_up")
        image_up.resize(800, 600)
        image_up.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QWidget(image_up)
        ...
        image_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(image_up)

        QMetaObject.connectSlotsByName(image_up)

    # setupUi

    def retranslateUi(self, image_up):
        image_up.setWindowTitle(QCoreApplication.translate("image_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("image_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("image_up", "<html><head/><body><p>\u8bc6\u56fe</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("image_up", "\u9996\u9875", None))
