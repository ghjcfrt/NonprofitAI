...
class Ui_fund_up:
    def setupUi(self, fund_up):  # noqa: PLR0915
        if not fund_up.objectName():
            fund_up.setObjectName("fund_up")
        fund_up.resize(800, 600)
        self.centralwidget = QWidget(fund_up)
        ...
        fund_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(fund_up)

        QMetaObject.connectSlotsByName(fund_up)

    # setupUi

    def retranslateUi(self, fund_up):
        fund_up.setWindowTitle(QCoreApplication.translate("fund_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("fund_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("fund_up", "<html><head/><body><p>\u57fa\u91d1</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("fund_up", "\u9996\u9875", None))
