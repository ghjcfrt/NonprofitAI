...
class Ui_bbs_up:
    def setupUi(self, bbs_up):  # noqa: PLR0915
        if not bbs_up.objectName():
            bbs_up.setObjectName("bbs_up")
        bbs_up.resize(800, 600)
        self.centralwidget = QWidget(bbs_up)
        ...
        bbs_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(bbs_up)

        QMetaObject.connectSlotsByName(bbs_up)

    # setupUi

    def retranslateUi(self, bbs_up):
        bbs_up.setWindowTitle(QCoreApplication.translate("bbs_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("bbs_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("bbs_up", "<html><head/><body><p>\u8bba\u575b</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("bbs_up", "\u9996\u9875", None))
