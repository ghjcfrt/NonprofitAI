...
class Ui_feedback_up:
    def setupUi(self, feedback_up):  # noqa: PLR0915
        if not feedback_up.objectName():
            feedback_up.setObjectName("feedback_up")
        feedback_up.resize(800, 600)
        self.centralwidget = QWidget(feedback_up)
        ...
        feedback_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(feedback_up)

        QMetaObject.connectSlotsByName(feedback_up)

    # setupUi

    def retranslateUi(self, feedback_up):
        feedback_up.setWindowTitle(QCoreApplication.translate("feedback_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("feedback_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("feedback_up", "<html><head/><body><p>\u53cd\u9988</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("feedback_up", "\u9996\u9875", None))
