...
class Ui_chat_up:
    def setupUi(self, chat_up):  # noqa: PLR0915
        if not chat_up.objectName():
            chat_up.setObjectName("chat_up")
        chat_up.resize(800, 600)
        chat_up.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QWidget(chat_up)
        ...
        chat_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(chat_up)

        QMetaObject.connectSlotsByName(chat_up)

    # setupUi

    def retranslateUi(self, chat_up):
        chat_up.setWindowTitle(QCoreApplication.translate("chat_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("chat_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("chat_up", "<html><head/><body><p>\u54a8\u8be2</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("chat_up", "\u9996\u9875", None))
