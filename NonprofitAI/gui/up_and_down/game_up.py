...
class Ui_game_up:
    def setupUi(self, game_up):  # noqa: PLR0915
        if not game_up.objectName():
            game_up.setObjectName("game_up")
        game_up.resize(800, 600)
        game_up.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QWidget(game_up)
        ...
        game_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(game_up)

        QMetaObject.connectSlotsByName(game_up)

    # setupUi

    def retranslateUi(self, game_up):
        game_up.setWindowTitle(QCoreApplication.translate("game_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("game_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("game_up", "<html><head/><body><p>\u5c0f\u6e38\u620f</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("game_up", "\u9996\u9875", None))
