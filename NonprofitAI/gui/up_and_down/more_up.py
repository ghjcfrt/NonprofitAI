...
class Ui_more_up:
    def setupUi(self, more_up):  # noqa: PLR0915
        if not more_up.objectName():
            more_up.setObjectName("more_up")
        more_up.resize(800, 600)
        more_up.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QWidget(more_up)
        ...
        more_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(more_up)

        QMetaObject.connectSlotsByName(more_up)

    # setupUi

    def retranslateUi(self, more_up):
        more_up.setWindowTitle(QCoreApplication.translate("more_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("more_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("more_up", "<html><head/><body><p>\u66f4\u591a</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("more_up", "\u9996\u9875", None))
