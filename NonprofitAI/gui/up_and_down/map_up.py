...
class Ui_map_up:
    def setupUi(self, map_up):  # noqa: PLR0915
        if not map_up.objectName():
            map_up.setObjectName("map_up")
        map_up.resize(800, 600)
        self.centralwidget = QWidget(map_up)
        ...
        map_up.setCentralWidget(self.centralwidget)

        self.retranslateUi(map_up)

        QMetaObject.connectSlotsByName(map_up)

    # setupUi

    def retranslateUi(self, map_up):
        map_up.setWindowTitle(QCoreApplication.translate("map_up", "MainWindow", None))
        self.back.setText(QCoreApplication.translate("map_up", "<\u8fd4\u56de", None))
        self.page_name.setText(
            QCoreApplication.translate("map_up", "<html><head/><body><p>\u5730\u56fe</p></body></html>", None)
        )
        self.home_page.setText(QCoreApplication.translate("map_up", "\u9996\u9875", None))
